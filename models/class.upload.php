...
/*
  ...
  //default settings
  public $destination = PATH_UPLOAD;
  ...
  $this->destination = PATH_UPLOAD.DS.$newDestination;
  }
...
// | Email         info@mssinfotech.com                                          |
// | Web           http://www.mssinfotech.com                                     |
// +------------------------------------------------------------------------+
...
class upload {
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            $this->file_dst_path = PATH_UPLOAD . DS . $server_path;
