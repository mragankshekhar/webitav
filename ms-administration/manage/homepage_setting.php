<?php
$pgMod = "homepage_setting";
$pgAct = "view";
$pgTable = SETTINGS;
$pgHeading = "Homepage Setting";
        ...
        if (!isset($_POST['field']) || trim($_POST['field']) == '') {
           ...
           $aryData=array(	
			...
			if($_POST['input_type']=='text'){
				$aryData[$lang]=$_POST['txt_val'];
			}
			elseif($_POST['input_type']=='textarea'){
				$aryData[$lang]=$_POST['txtarea_val'];
			}
			elseif(isset($_FILES["file_val"]["name"]) && !empty($_FILES["file_val"]["name"]))
			{  
			...
			foreach($_FILES['file']['name'] as $key=>$val)
			{
				...
				if(in_array($lext,array('jpeg','jpg','gif','png')))
				{
					if(move_uploaded_file($_FILES['file']['tmp_name'][$key],PATH_MEDIA.DS.$_FILES['file']['name'][$key])){				
						...
						$err.=PATH_MEDIA.DS.$_FILES['file']['name'][$key]." is in invalid folder";
					}
				}else{
            ...
            <div class="panel">
                ...
                <div class="panel-body">
					...
					if ($pgAct == "add" ) {
                        ...
                        <form  class="form-horizontal form_ajax" enctype="multipart/form-data" role="form" id="signupForm" method="post" action="file:///D|/anurekha/tuafica/taufica/ms-administration/manage/?page_id=<?php echo $pgMod; ?>">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    ...
                    ?>
                    <form class="form-horizontal form_ajax" role="form" id="signupForm" method="post" action="file:///D|/anurekha/tuafica/taufica/ms-administration/manage/?page_id=<?php echo $pgMod; ?>" enctype="multipart/form-data">
                    ...
                    <?php } ?>
                        ...
                        foreach ($aryForm as $key => $value) {
                            ...
                            <div class="form-group">
								...
								$aryPgAct['page_id']="homepage_setting";
